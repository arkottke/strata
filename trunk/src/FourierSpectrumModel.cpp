...
FourierSpectrumModel::FourierSpectrumModel(RvtMotion * rvtMotion, bool isEditable, QObject *parent)
	: QAbstractTableModel(parent), m_rvtMotion(rvtMotion), m_isEditable(isEditable)
{
...
void FourierSpectrumModel::setIsEditable(bool editable)
{
    m_isEditable = editable;
}
        
void FourierSpectrumModel::resetModel()
{
    reset();
}
