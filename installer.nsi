...
;Main libraries
File "${MINGW_PATH}\bin\Qt6Core.dll"
File "${MINGW_PATH}\bin\Qt6Gui.dll"
File "${MINGW_PATH}\bin\Qt6PrintSupport.dll"
File "${MINGW_PATH}\bin\Qt6Svg.dll"
File "${MINGW_PATH}\bin\Qt6OpenGL.dll"
File "${MINGW_PATH}\bin\Qt6OpenGLWidgets.dll"
File "${MINGW_PATH}\bin\Qt6Widgets.dll"
File "${MINGW_PATH}\bin\Qt6Xml.dll"
...
File "${MINGW_PATH}\bin\libicudt61.dll"
File "${MINGW_PATH}\bin\libicuin61.dll"
File "${MINGW_PATH}\bin\libicuuc61.dll"
File "${MINGW_PATH}\bin\libintl-8.dll"
File "${MINGW_PATH}\bin\libpcre-1.dll"
File "${MINGW_PATH}\bin\libpcre2-16-0.dll"
