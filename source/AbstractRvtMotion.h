...
class AbstractRvtMotion : public AbstractMotion {
  ...
  friend auto operator<<(QDataStream &out, const AbstractRvtMotion *arm)
      -> QDataStream &;
  friend auto operator>>(QDataStream &in, AbstractRvtMotion *arm)
      -> QDataStream &;
...
public:
  ...
  //! Compute the maximum response of the motion and the applied transfer
  //! function
  auto max(const QVector<std::complex<double>> &tf =
               QVector<std::complex<double>>()) const -> double;
  auto maxVel(const QVector<std::complex<double>> &tf =
                  QVector<std::complex<double>>()) const -> double;
  auto maxDisp(const QVector<std::complex<double>> &tf =
                   QVector<std::complex<double>>()) const -> double;
  auto calcMaxStrain(const QVector<std::complex<double>> &tf =
                         QVector<std::complex<double>>()) const -> double;
  ...
  auto absFourierAcc(const QVector<std::complex<double>> &tf =
                         QVector<std::complex<double>>()) const
      -> const QVector<double>;
  auto absFourierVel(const QVector<std::complex<double>> &tf =
                         QVector<std::complex<double>>()) const
      -> const QVector<double>;
  auto absFourierDisp(const QVector<std::complex<double>> &tf =
                          QVector<std::complex<double>>()) const
      -> const QVector<double>;
...
protected:
  ...
  enum Column { FrequencyColumn, AmplitudeColumn };
  ...
  //! Take a comma separated string, split the columns, and return the specified
  //! column
  ...
  //! Amplitudes of the Fourier amplitude spectrum corresponding to the
  //! acceleration
...
auto loadRvtMotionFromTextFile(const QString &fileName, double scale = 1.)
    -> AbstractRvtMotion *;
