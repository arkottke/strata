...
auto PathDurationModel::headerData(int section, Qt::Orientation orientation,
...
auto PathDurationModel::data(const QModelIndex &index, int role) const
    -> QVariant {
...
auto PathDurationModel::setData(const QModelIndex &index, const QVariant &value,
                                int role) -> bool {
