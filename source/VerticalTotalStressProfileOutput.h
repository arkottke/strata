...
#ifndef VERTICAL_TOTAL_STRESS_PROFILE_OUTPUT_H
#define VERTICAL_TOTAL_STRESS_PROFILE_OUTPUT_H

#include "AbstractProfileOutput.h"

class AbstractCalculator;

class VerticalTotalStressProfileOutput : public AbstractProfileOutput
{
    Q_OBJECT
public:
...
#endif // VERTICAL_TOTAL_STRESS_PROFILE_OUTPUT_H
