...
class SiteResponseModel : public QThread {
  ...
  friend auto operator<<(QDataStream &out, const SiteResponseModel *srm)
      -> QDataStream &;
  friend auto operator>>(QDataStream &in, SiteResponseModel *srm)
      -> QDataStream &;
...
public:
  ...
  enum Method {
    ...
    FrequencyDependent //!< Equivalent-linear with frequency dependent
                       //!< properties
  };
