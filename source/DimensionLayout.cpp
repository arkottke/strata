...
DimensionLayout::DimensionLayout(QWidget *parent) : QFormLayout(parent) {
  // Minimum
...
void DimensionLayout::updateMaxMin(double min) { _maxSpinBox->setMinimum(min); }

void DimensionLayout::updateMinMax(double max) { _minSpinBox->setMaximum(max); }
