...
auto TextLog::level() const -> TextLog::Level { return _level; }
...
void TextLog::setLevel(int level) { setLevel((Level)level); }

auto TextLog::text() const -> const QStringList & { return _text; }
