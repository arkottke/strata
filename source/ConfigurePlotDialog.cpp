...
void AxisOptions::setDefaults(const QwtScaleEngine *scaleEngine, bool autoScale,
...
ConfigurePlotDialog::ConfigurePlotDialog(QwtPlot *plot, QWidget *parent)
  ...
  _xAxisOptions->setDefaults(_plot->axisScaleEngine(QwtPlot::xBottom),
  ...
  _yAxisOptions->setDefaults(_plot->axisScaleEngine(QwtPlot::yLeft),
