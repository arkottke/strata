...
RockLayer::RockLayer(QObject *parent) : VelocityLayer(parent) {
  _untWt = 22.0;
  setAvgDamping(1.0);
}

auto RockLayer::untWt() const -> double { return _untWt; }
...
auto RockLayer::toString() const -> QString { return QString("Bedrock"); }

auto RockLayer::damping() const -> double { return _damping; }

void RockLayer::setDamping(double damping) { _damping = damping; }

auto RockLayer::avgDamping() const -> double { return _avgDamping; }
