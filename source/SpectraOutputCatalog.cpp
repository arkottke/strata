...
auto SpectraOutputCatalog::data(const QModelIndex &index, int role) const
    -> QVariant {
...
auto SpectraOutputCatalog::setData(const QModelIndex &index,
...
auto SpectraOutputCatalog::headerData(int section, Qt::Orientation orientation,
...
auto SpectraOutputCatalog::flags(const QModelIndex &index) const
    -> Qt::ItemFlags {
...
auto SpectraOutputCatalog::removeRows(int row, int count,
...
auto operator<<(QDataStream &out, const SpectraOutputCatalog *soc)
    -> QDataStream & {
  out << (quint8)1;
