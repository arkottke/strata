...
class NonlinearProperty : public QAbstractTableModel {
  ...
  friend auto operator<<(QDataStream &out, const NonlinearProperty *np)
      -> QDataStream &;
  friend auto operator>>(QDataStream &in, NonlinearProperty *np)
      -> QDataStream &;
