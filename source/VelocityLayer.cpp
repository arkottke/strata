...
VelocityLayer::VelocityLayer(QObject *parent) : AbstractDistribution(parent) {
  _isVaried = true;
  _depth = 0;
}
...
auto VelocityLayer::depth() const -> double { return _depth; }
void VelocityLayer::setDepth(double depth) { _depth = depth; }

auto VelocityLayer::shearVel() const -> double { return _varied; }

auto VelocityLayer::shearMod() const -> double {
  return density() * shearVel() * shearVel();
}

auto VelocityLayer::isVaried() const -> bool { return _isVaried; }

void VelocityLayer::setIsVaried(bool isVaried) { _isVaried = isVaried; }
